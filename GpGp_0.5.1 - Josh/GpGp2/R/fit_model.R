...
#' See \code{\link{GpGp2}} for information about supported covariance funtions.
...
#' @return An object of class \code{GpGp2_fit}, which is a list containing
...
#' Print summary of GpGp2 fit
#'
#' @param object Object of class "GpGp2_fit", usually the return value from
#' \code{\link{fit_model}}
#' @param ... additional arguments, for compatability with S3 generic 'summary'
#' @export
summary.GpGp2_fit <- function(object, ...){
