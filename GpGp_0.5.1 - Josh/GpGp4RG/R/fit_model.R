...
#' See \code{\link{GpGp4RG}} for information about supported covariance funtions.
...
#' @return An object of class \code{GpGp4RG_fit}, which is a list containing
...
fit_model <- function(y, locs, X = NULL, covfun_name = "matern_isotropic",
    ...
    fit$locs <- locs
    fit$X <- X
    class(fit) <- "GpGp4RG_fit"
    return(fit)
}



#' Print summary of GpGp4RG fit
#'
#' @param object Object of class "GpGp4RG_fit", usually the return value from
#' \code{\link{fit_model}}
#' @param ... additional arguments, for compatability with S3 generic 'summary'
#' @export
summary.GpGp4RG_fit <- function(object, ...){
